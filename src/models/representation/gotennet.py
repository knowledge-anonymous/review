...
from src.models.components.ops import Dense, str2basis, get_weight_init_by_string, str2act, MLP, Distance, CosineCutoff, \
    VecLayerNorm
from src.models.components.ops import parse_update_info, TensorInit, NodeInit, EdgeInit
...
class GotenNet(nn.Module):
    def __init__(
        ...
        self.neighbor_embedding = NodeInit([self.hidden_dim // 2, self.hidden_dim], n_rbf, self.cutoff, max_z=max_z,
